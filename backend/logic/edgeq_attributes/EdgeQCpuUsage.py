...
# Update refresh such that it stores cpu usage for the most recent 100 entries
# on refresh, remove the oldest data and add the newest data
class EdgeQCpuUsage(Attribute):
    ...
    def get_cpu_usage(self):
        """
        EdgeQ-specific CPU monitoring using /proc/stat
